/**
 * Daily Market Digest — lightweight leveled logger
 * ────────────────────────────────────────────────────────────
 * Owner / Creator: Itachi
 * Made by CRYPTFRANI
 *
 * Zero-dependency, low-overhead console logger. Timestamped, level-gated,
 * and tag-aware so each subsystem (market, digest, delivery, ...) is easy to grep.
 */
 ...
 * @param {string} [tag] e.g. 'market', 'digest', 'delivery'
 */
